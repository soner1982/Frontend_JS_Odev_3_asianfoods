...
let buttons = 
		` <button type="button" class="btn btn-outline-dark" id="all">All</button>
          <button type="button" class="btn btn-outline-dark mx-3" id="korea">Korea</button>
          <button type="button" class="btn btn-outline-dark" id="japan">Japan</button>
          <button type="button" class="btn btn-outline-dark mx-3" id="china">China</button>
		`
